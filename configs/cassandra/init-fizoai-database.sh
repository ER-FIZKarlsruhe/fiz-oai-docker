...
cqlsh cassandra-oai 9042 -u cassandra -p cassandra -e "GRANT ALL PERMISSIONS ON KEYSPACE fizoaibackend to fizoaibackend;"

cqlsh cassandra-oai 9042 -u cassandra -p cassandra -e "ALTER USER cassandra WITH PASSWORD '@@CASSANDRA_SUPERUSER_PASSWORD@@';"
